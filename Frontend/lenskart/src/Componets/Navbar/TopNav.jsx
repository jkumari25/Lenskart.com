...
import { Text, Image, Box, HStack, Avatar, Heading, Flex, border, } from '@chakra-ui/react';
  ...
  return (
      ...
      <div className={Styles.tn_div_2} style={{ width: '100%'}}>
        <Box bg="#FFFFFF" mt="0.5%">
          ...
          <Box display="flex" p="0%" >
            ...
            <Box fontSize="13px" fontFamily="sans-serif" w="35%" ml="0.5%" >
              <Box pt="5%" display="flex" justifyContent="space-evenly" color={'black'}>
                Track order
    ...
    return(
        ...
        <div className={Styles.tn_div_1} style={{width:'100%'}}>
          ...
          <HStack fontWeight="bold" bg="#FBF9F7" fontFamily="sans-serif" h="65px" w="100%" position="relative" >
            <Hover />
